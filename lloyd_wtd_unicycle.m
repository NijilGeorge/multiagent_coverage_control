...
%             wait('unicycle_polar_on_spot_simulink.slx','stateOfJob',timeout);
    ...
    if showPlot
        ...
        drawnow
        filename1 = '/home/nijil/Documents/Nijil/MTP/Report/Simultaion Figures/homogeneous/15agents/path.gif';
        ...
        filename3 = '/home/nijil/Documents/Nijil/MTP/Report/Simultaion Figures/homogeneous/15agents/costvsiter.gif';
        ...
        title('Cost Function');
        colorbar
        filename2 = '/home/nijil/Documents/Nijil/MTP/Report/Simultaion Figures/homogeneous/15agents/cost_function.gif';
...
function [Cx,Cy] = WtPolyCentroid(Xa,Ya,iter)
    ...
    global M;
    global binary_obst;
    M1=M+0*(exp(-0.05*iter))*binary_obst;
    Xn=X(:);
    Yn=Y(:);
    Xa = [Xa(2:end);Xa(1)];
    Ya = [Ya(2:end);Ya(1)];
